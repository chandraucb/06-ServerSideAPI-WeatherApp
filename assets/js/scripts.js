...
var getCityLatLong = function (city) {
  ...
  var createCurrentDayWeather = function (city , currentDayData) {
    ...
    cardHeaderEl.textContent = city + ' ' + dayjs.unix(currentDayData.dt).format('MM/DD/YYYY')

    var iconEl = document.createElement('img')

    iconEl.setAttribute('alt', 'Weather icon')
    iconEl.setAttribute('src', 'http://openweathermap.org/img/w/' + currentDayData.weather[0].icon + '.png')
    ...
    //let minTemp = ((currentDayData.main.temp_min - 273.15) * 9/5) + 32
    //let maxTemp = ((currentDayData.main.temp_max - 273.15) * 9/5) + 32
    ...
    cardDetails.innerHTML = "Temp " + temp + "&deg;F <br> Wind " + Math.round(currentDayData.wind.speed * 2.237 * 2)/2 + " MPH <br> Humidity " + currentDayData.main.humidity + " %"
